...
export function SwitchField({ className, ...props }: HeadlessFieldProps): ReactElement {
  return (
    <HeadlessField
      data-slot="field"
      {...props}
...
const colors = {
  brand: [
    '[--switch-bg-ring:theme(colors.brand.500/80%)] [--switch-bg:theme(colors.brand.400)] dark:[--switch-bg-ring:transparent]',
    '[--switch-ring:transparent] [--switch-shadow:transparent] [--switch:theme(colors.brand.950)]',
  ],
  'dark/zinc': [

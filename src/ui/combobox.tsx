    ...
    >
      <div className="relative">
        <div>
          ...
          >
            <HeadlessComboboxInput
              className={clsx([
                // Basic layout
                'relative block w-full appearance-none rounded-lg px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing[3])-1px)] sm:py-[calc(theme(spacing[1.5])-1px)] sm:pr-6',
        ...
        <HeadlessComboboxOptions
          className={clsx(
            'absolute z-10 mt-1 max-h-60 w-fit overflow-auto whitespace-nowrap rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm'
          )}
        >
          <div>

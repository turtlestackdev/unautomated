...
} & Omit<HeadlessListboxProps<typeof Fragment, T>, 'multiple'>): ReactElement {
  return (
    <HeadlessListbox {...props} multiple={false}>
      ...
      >
        <HeadlessListboxSelectedOption
          ...
          options={options}
          placeholder={
            placeholder ? <span className="block truncate text-zinc-500">{placeholder}</span> : null
          }
        />
...
export function ListboxOption<T>({
  ...
  children?: React.ReactNode;
} & HeadlessListboxOptionProps<'div', T>): ReactElement {
...
export function ListboxLabel({
  className,
  ...props
}: React.ComponentPropsWithoutRef<'span'>): ReactElement {
  return (
    <span

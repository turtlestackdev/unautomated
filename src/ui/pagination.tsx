...
export function Pagination({
  ...
  className,
  ...props
}: React.ComponentPropsWithoutRef<'nav'>): ReactElement {
...
export function PaginationList({ children }: { children: React.ReactNode }): ReactElement {
...
export function PaginationGap(): ReactElement {
  return (
    <div
      aria-hidden="true"

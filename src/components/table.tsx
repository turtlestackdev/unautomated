...
export function TableHead({
  className,
  ...props
}: React.ComponentPropsWithoutRef<'thead'>): ReactElement {
  return <thead className={clsx(className, 'text-zinc-500 dark:text-zinc-400')} {...props} />;
}

export function TableBody(props: React.ComponentPropsWithoutRef<'tbody'>): ReactElement {
  return <tbody {...props} />;
}
...
export function TableRow({
  ...
  target?: string;
  title?: string;
} & React.ComponentPropsWithoutRef<'tr'>): ReactElement {
...
export function TableHeader({
  className,
  ...props
}: React.ComponentPropsWithoutRef<'th'>): ReactElement {
...
export function TableCell({
  ...
  children,
  ...props
}: React.ComponentPropsWithoutRef<'td'>): ReactElement {

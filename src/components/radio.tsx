...
export function RadioGroup({ className, ...props }: HeadlessRadioGroupProps): ReactElement {
  return (
    <HeadlessRadioGroup
      data-slot="control"
      {...props}
...
export function RadioField({ className, ...props }: HeadlessFieldProps): ReactElement {
  return (
    <HeadlessField
      data-slot="field"
      {...props}
...
export function Radio({
  ...
  className,
  ...props
}: { color?: Color; className?: string } & HeadlessRadioProps): ReactElement {
  return (
    <HeadlessRadio
      data-slot="control"
      {...props}

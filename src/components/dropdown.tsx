...
export function Dropdown(props: HeadlessMenuProps): ReactElement {
...
export function DropdownSection({ className, ...props }: HeadlessMenuSectionProps): ReactElement {
  return (
    <HeadlessMenuSection
      {...props}
      className={clsx(
...
export function DropdownHeading({ className, ...props }: HeadlessMenuHeadingProps): ReactElement {
  return (
    <HeadlessMenuHeading
      {...props}
      className={clsx(
...
export function DropdownSeparator({
  className,
  ...props
}: HeadlessMenuSeparatorProps): ReactElement {
  return (
...
export function DropdownLabel({ className, ...props }: HeadlessLabelProps): ReactElement {
  return (
    <HeadlessLabel
      {...props}
...
export function DropdownDescription({
  className,
  ...props
}: HeadlessDescriptionProps): ReactElement {
  return (
    <HeadlessDescription
...
export function DropdownShortcut({
  ...
  keys,
  ...props
}: { keys: string | string[] } & HeadlessDescriptionProps<'kbd'>): ReactElement {
  return (
    <HeadlessDescription
      as="kbd"
      {...props}
